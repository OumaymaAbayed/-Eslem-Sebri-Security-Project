...
# File paths
key_path = os.path.join(base_path, "encryption.key")
csv_path = os.path.join(base_path, "tayara_vehicles_cleaned.csv")
output_path = os.path.join(base_path, "tayara_vehicles_encrypted.csv")
